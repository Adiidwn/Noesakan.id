...
import {
  ...
  FaComment,
  FaShare,
} from "react-icons/fa"; // Import ikon gambar
      ...
      <Center>
        ...
        <Box flex="1" p={6} w={"50%"}>
          ...
          <Box mt={5} p={4} bgColor={"white"} rounded={"md"} boxShadow={"md"}>
            <Card bgColor={"white"} marginTop={"15px"} w={"full"} p={2}>
              ...
              <Box mt={6}>
                <Text fontWeight={600} mb={2}>
                  Di Cari supplier ikan tuna segar untuk kebutuhan ekspor ikan..
                  kebutuhan 30 ton, silahkan tawarkan melalui wa: 087635242426.
                </Text>
                <img
                  src={
              ...
              <Box mt={4} display="flex" marginLeft={4}>
                <Box display="flex" alignItems="center">
                  <Icon as={AiOutlineLike} boxSize={4} color="gray.500" />
                  <Text fontSize="sm" ml={1} color="gray.800">
                    10
                  </Text>
                </Box>
                <Box display="flex" alignItems="center" marginLeft={"20px"}>
                  <Icon as={BiComment} boxSize={4} color="gray.500" />
                  <Text fontSize="sm" ml={1} color="gray.800">
                    5
                  </Text>
                </Box>
                <Box display="flex" alignItems="center" marginLeft={"20px"}>
                  <Icon as={BiShareAlt} boxSize={4} color="gray.500" />
                  <Text fontSize="sm" ml={1} color="gray.800">
                    Bagikan
                  </Text>
                </Box>
            ...
            <Card bgColor={"white"} marginTop={"15px"} w={"full"} p={2}></Card>
          </Box>
    ...
    <Link to={"/DetailArticle"}>
      ...
      >
        <Box mt={4} display="flex" alignItems="center">
          <img
            src={
              "https://images.unsplash.com/photo-1535443120147-89aef0b5327a?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
            }
            alt="Gambar Terbaru"
    ...
    <Link to={"/DetailArticle"}>
      ...
      >
        <Box mt={4} display="flex" alignItems="center">
          <img
            src={
              "https://images.unsplash.com/photo-1487335414417-ac48b43a8cc7?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=2070&q=80"
            }
            alt="Gambar Terbaru"
            style={{ maxWidth: "100%", maxHeight: "60px" }}
          />
          <Text fontWeight={200} fontSize="md" ml={2} color={"#00BFFF"}>
            Nilai Produksi Rp 2,24 T, Laut Banten Jadi Tambang Investasi
            Perikanan
          </Text>
        </Box>
        <Box mt={2} p={2}>
          <Text fontWeight={100} mb={2} fontSize={"sm"}>
            Gubernur Provinsi Banten Al Muktabar mengatakan Banten memiliki
            kekayaan alam
          </Text>
          <Text fontSize="sm" color="blue.500" cursor="pointer">
            Baca Selengkapnya
