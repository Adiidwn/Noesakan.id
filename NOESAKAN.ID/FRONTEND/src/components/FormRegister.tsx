...
export default function SignupCard() {
  ...
  return (
    <Box position={"relative"} objectFit={"cover"} bgImage={"https://images.unsplash.com/photo-1498654200943-1088dd4438ae?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1470&q=80"} w={"full"}>
      <Container
        as={SimpleGrid}
        maxW={"100%"}
        columns={{ base: 1, md: 2 }}
          ...
          <Box as={"form"} mt={5}>
            <Stack spacing={4}>
              <FormControl id="name" isRequired>
                <FormLabel color={"black"} ml={"10px"}>Nama Lengkap</FormLabel>
                <Input
                  bg={"gray.100"}
                  border={0}
                  color={"gray.500"}
              ...
              <FormControl id="username" isRequired>
                <FormLabel color={"black"} ml={"10px"}>Username</FormLabel>
                <Input
                  bg={"gray.100"}
                  border={0}
                  color={"gray.500"}
              ...
              <FormControl id="email" isRequired>
                <FormLabel color={"black"} ml={"10px"}>Email</FormLabel>
                <Input
                  bg={"gray.100"}
                  border={0}
                  color={"gray.500"}
              ...
              <FormLabel color={"black"} ml={"10px"}>Password</FormLabel>
              <InputGroup>
                <Input type={showPassword ? 'text' : 'password'} bg={"gray.100"}
                  border={0}
                  color={"gray.500"}
                  _placeholder={{
                    color: "gray.500",
